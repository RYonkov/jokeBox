namespace FightingArena.Tests
{
    ...
    {
        //[Test]
        //public void Whether_Constructor_Works()
        //{
        //    string expectedName = "rado";
        //    int expectedDamage = 10;
        //    int expectedHP = 19;

        //    Warrior warrior = new Warrior(expectedName, expectedDamage, expectedHP);

        //    string actualName = (string)GetField("name").GetValue(warrior);
        //    Assert.AreEqual(expectedName, actualName);

        //    //Assert.AreEqual((int)expectedDamage, warrior.Damage);
        //    //Assert.AreEqual((int)expectedHP, warrior.HP);            
        //}
        ...
        public void TestNameGetter()
        {
            ...
            Warrior warrior = new Warrior(expectedName, 30, 20);
        ...
        public void TestNameSetterValidation(string name)
        {
            ...
            {
                Warrior warrior = new Warrior(name, 26, 24);
        ...
        {
            int expectedDamage = 44;
            Warrior warrior = new Warrior("Pesho", expectedDamage, 22);
        ...
        public void TestDamageSetterValidation(int damage)
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Warrior warrior = new Warrior("Ivan", damage, 66);
